  ...
  <div class="intro-y col-span-12 overflow-x-auto">
    <table class="table table-list table-bordered table-hover -mt-2">
      <thead class="table-light">
        <th class="text-left">
          {{ $t("timeReport.startMoving") }} <span class="text-danger">*</span>
        </th>
        <th class="text-left">
          {{ $t("timeReport.dateTime") }}
          <span class="text-danger">*</span>
        </th>
        <th class="text-left">{{ $t("timeReport.rank") }}</th>
        <th class="text-left">
        ...
        <th class="text-left">{{ $t("timeReport.totalWork") }}</th>
...
let sumTimeMoving = () => {
  ...
  timeReportStore.totalStartMoving = sumTime;
...
watch(
  () => [timeReportStore.startMoving.validateFlow, props.typeValidate],
  () => {
    ...
    validateType(timeReportStore.startMoving, timeReportStore.startMoving.type);
  }
);
